...
(function($) {
    $.fn.amazingaudioplayer = function(options) {
        var PlayerSkin = function(amazingPlayer, container, options, id) {
            ...
            this.container.on("amazingaudioplayer.played", function(event, currentItem) {
                ...
                if (instance.options.enablega && instance.options.gatrackingid && window.ga) ga("send", "event", instance.options.gacategory, "play", instance.amazingPlayer.elemArray[currentItem].title, instance.options.gaeventvalue)
            });
            ...
            this.container.on("amazingaudioplayer.stopped", function(event, currentItem) {
                ...
                if (instance.options.enablega && instance.options.gatrackingid && window.ga) ga("send", "event", instance.options.gacategory, "stop", instance.amazingPlayer.elemArray[currentItem].title,
                    instance.options.gaeventvalue)
            });
            this.container.on("amazingaudioplayer.ended", function(event, currentItem) {
                if (instance.options.enablega && instance.options.gatrackingid && window.ga) ga("send", "event", instance.options.gacategory, "end", instance.amazingPlayer.elemArray[currentItem].title, instance.options.gaeventvalue)
            });
            ...
            if (this.options.showtime) {
                ...
                this.container.on("amazingaudioplayer.playprogress", function(event, data) {
                    ...
                    var t;
                    if (data.live) t = instance.options.timeformatlive.replace("%CURRENT%",
                        current);
            ...
            if (this.options.showtracklist) {
                ...
                for (var i = 0; i < this.amazingPlayer.elemLength; i++) {
                    ...
                    if (this.tracklistItemHeight <= 0) {
                        ...
                        this.tracklistItemHeight = $trackclone.height();
                        $trackclone.remove()
                    }
                }
                this.$tracklist.css({
                ...
                if (this.options.tracklistitem < this.amazingPlayer.elemLength) {
                    ...
                    if (this.options.tracklistscroll) {
                        var totalheight =
                            this.$tracks.height();
                        var visibleheight = this.$tracklist.height();
                        var thumbheight = Math.ceil(visibleheight * visibleheight / totalheight);
                        if (thumbheight < this.options.minthumb) thumbheight = this.options.minthumb;
                        this.$tracklist.css({
            ...
            if (this.options.addwm &&
                ...
                var $wm = $("<div style='position:absolute;top:100%;right:0;margin:4px;text-align:right;font:normal 10px Arial, sans-serif;'><a href='" + this.options.lvm + "' target='_blank' style='color:#666;text-decoration:none;' class='amazingaudioplayer-mark'>" + this.options.pvm + "</a></div>");
        ...
        FlashHTML5Player.prototype = {
            initFlash: function() {
                var objectId = "amazingflashaudioplayer-" +
                    this.id;
            ...
            initHtml5: function() {
                ...
                html5Audio.addEventListener("timeupdate", function() {
                    instance.amazingPlayer.playProgress(html5Audio.currentTime * 1E3, html5Audio.duration *
                        1E3)
                });
            ...
            load: function(audioItem) {
                ...
                if (this.amazingPlayer.options.forcefirefoxflash && AmazingAudioPlatforms.isFirefox() &&
                    !AmazingAudioPlatforms.isMobile()) this.isHtml5 = false;
            ...
            html5LoadAudio: function() {
                ...
                this.html5LoadUpdate = setInterval(function() {
                    if (html5Audio.buffered && html5Audio.buffered.length > 0 && !isNaN(html5Audio.buffered.end(0)) &&
            ...
            play: function(startTime, duration) {
                if (this.isHtml5) {
                    ...
                    if (startTime > 0) this.html5Object.get(0).currentTime =
                        startTime
            ...
            setTime: function(pos, duration) {
                if (this.isHtml5)
                    ...
                    else this.html5Object.get(0).currentTime =
                        duration * pos;
        ...
        AmazingAudioPlayer.prototype = {
            ...
            readTags: function() {
                ...
                $("ul.amazingaudioplayer-audios", this.container).find("li").each(function() {
                    ...
                    instance.elemArray.push({
                        ...
                        radionomyradiouid: $this.data("radionomyradiouid") ?
            ...
            init: function(instance) {
                ...
                var firstId = 0;
                if ("firstaudioid" in params && !isNaN(params["firstaudioid"]) &&
                    params["firstaudioid"] >= 0 && params["firstaudioid"] < instance.elemLength) firstId = params["firstaudioid"];
            ...
            createSkin: function() {
                new PlayerSkin(this, this.container,
            ...
            audioRun: function(index, autoPlay) {
                ...
                if (this.elemArray[this.currentItem].live) {
                    ...
                    } else if (this.options.updateshoutcast) this.updateLiveShoutcast()
                }
                this.checkMK()
            },
                ...
                $.ajax({
                    ...
                    if (tracks && tracks.length > 0) {
                        ...
                        if (track && track.length > 0) {
                            ...
                            var artists = track.find("artists").text();
                            var callmeback = track.find("callmeback").text();
                            if (title && title.length > 0) instance.elemArray[instance.currentItem].title = title;
                            if (artists && artists.length > 0) instance.elemArray[instance.currentItem].artists = artists;
                            instance.container.trigger("amazingaudioplayer.updateinfo", instance.elemArray[instance.currentItem]);
                            instance.liveUpdateTimeout = setTimeout(function() {
            ...
            checkMK: function() {
                if (this.options.vm == "AMF" + "ree") {
                    var mklink = $(".amazingaudioplayer-mark",
                        this.container);
        ...
        this.each(function() {
            ...
            if ($("div#amazingaudioplayer_options").length) $.each($("div#amazingaudioplayer_options").data(),
                function(key, value) {
                    instance.options[key.toLowerCase()] = value
                });
            var searchoptions = {};
            ...
            var image_list = ["playpauseimage", "stopimage", "prevnextimage", "loopimage", "volumeimage", "tracklistarrowimage"];
    ...
    $.amascrollbar = function(parent, child, options) {
        ...
        scrollbar.css({
            ...
            "border-radius": Math.ceil(options.barwidth /
                2) + "px",
        ...
        var scrollChild = function(dis) {
            ...
            if (thumbtop > visibleheight - thumbheight) thumbtop =
